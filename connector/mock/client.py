...
class MockConnector(BaseConnector):
    ...
    def __init__(
        ...
        latency: float = 0.0,
        slippage_range: tuple[float, float] = (0.0, 0.0),
    ):
        """
        Args:
            initial_balance: Saldo inicial da conta.
            latency: Latência simulada em segundos (0 para testes rápidos).
            slippage_range: Range de slippage (min, max) em preço.
        """
        ...
        self._slippage_range = slippage_range
